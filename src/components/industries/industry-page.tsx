    ...
    <div className="flex flex-col min-h-screen bg-royal_blue_traditional-900 text-white">
      ...
      <section className="relative h-96 w-full" ref={heroRef}>
        <Image
          ...
          priority
        />
        <div className="absolute inset-0 bg-gradient-to-r from-royal_blue_traditional-900/90 to-royal_blue_traditional-800/70">
            ...
            <div className="max-w-2xl">
              <nav className="mb-8">
                <ol className="flex items-center space-x-2 text-sm text-gold-300">
                  ...
                  <li><Link href="/industries" className="hover:text-gold-200 transition-colors">Industries</Link></li>
                </ol>
              </nav>
      ...
      {/* Page Navigation */}
      <nav className="sticky top-0 z-50 bg-royal_blue_traditional-800 border-b border-royal_blue_traditional-700 shadow-lg">
        <div className="container mx-auto px-6">
          <ul className="flex space-x-8 overflow-x-auto">
            {['overview', 'case-studies', 'services', 'resources', 'global-services'].map((item) => (
              <li key={item}>
                <a 
                  href={`#${item}`} 
      ...
      {/* Overview Section */}
      <section id="overview" className="py-20 bg-royal_blue_traditional-800" ref={overviewRef}>
        <div className="container mx-auto px-6">
          <div className="flex flex-col lg:flex-row-reverse gap-12">
            ...
            <div className="lg:w-1/2 overview-content">
              <h2 className="text-4xl font-bold mb-6 text-white">{overview.title}</h2>
      ...
      <section id="case-studies" className="py-20 bg-royal_blue_traditional-900" ref={caseStudiesRef}>
        <div className="container mx-auto px-6">
          <h2 className="text-4xl font-bold mb-12 text-white">Case Studies</h2>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {caseStudies.map((study, index) => (
              <div key={index} className="case-study-card flex flex-col overflow-hidden rounded-lg bg-royal_blue_traditional-800 shadow-xl border border-royal_blue_traditional-700">
                ...
                <div className="p-6 flex flex-col flex-1">
                  ...
                  <Button variant="ghost" className="mt-auto text-gold-300 hover:text-gold-200 hover:bg-royal_blue_traditional-700">
      ...
      {/* Services Section */}
      <section id="services" className="py-20 bg-royal_blue_traditional-800" ref={servicesRef}>
        <div className="container mx-auto px-6">
          <h2 className="text-4xl font-bold mb-12 text-white">Our Services</h2>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {services.map((service, index) => (
              <div key={index} className="service-card p-8 bg-royal_blue_traditional-900 rounded-lg border border-royal_blue_traditional-700 shadow-xl hover:border-gold-500 transition-colors">
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {stats.map((stat, index) => (
              <div key={index} className="stat-card bg-royal_blue_traditional-800 p-8 rounded-lg border border-royal_blue_traditional-700 shadow-xl">
      ...
      <section id="resources" className="py-20 bg-royal_blue_traditional-800" ref={resourcesRef}>
        <div className="container mx-auto px-6">
          <h2 className="text-4xl font-bold mb-12 text-white">Resource Library</h2>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {resources.map((resource, index) => (
              <div key={index} className="resource-card flex flex-col overflow-hidden rounded-lg bg-royal_blue_traditional-900 shadow-xl border border-royal_blue_traditional-700">
                <div className="relative h-48">
                  <Image
      ...
      <section id="global-services" className="py-20 bg-royal_blue_traditional-900" ref={globalServicesRef}>
        <div className="container mx-auto px-6">
          <h2 className="text-4xl font-bold mb-12 text-gold-300">Services in your country</h2>
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12">
            {Object.entries(countryServices).map(([region, countries], index) => (
              <div key={index} className="region-section">
                <h3 className="text-xl font-bold mb-6 text-gold-300">{region}</h3>
