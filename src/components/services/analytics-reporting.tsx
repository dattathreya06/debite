...
const AnalyticsReportingPage = () => {
  const pageData: ServicePageProps = {
    ...
    description:
      "Transform your business data into actionable insights with powerful analytics tools",
    heroImage:
      "https://images.pexels.com/photos/577210/pexels-photo-577210.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2600",
    ...
    overview: {
      ...
      content: (
        <>
          <p className="mb-4">
            Debite's Advanced Analytics & Reporting solution turns your business
            data into clear, actionable insights. Our platform combines powerful
            analytics with easy-to-understand reporting, helping you make
            informed decisions about your business growth and financial health.
          </p>
          <p className="mb-4">
            ...
            customizable dashboards, and automated reports that help you stay
            ahead of market trends and opportunities.
          </p>
        </>
      ),
      image:
    ...
    capabilities: [
      {
        ...
        description:
          "Track revenue, expenses, and profitability with detailed financial metrics and trends.",
        icon: BarChart3,
      },
      {
        title: "Performance Monitoring",
        description:
          "Monitor KPIs and business metrics with real-time dashboards and alerts.",
        icon: TrendingUp,
      },
      {
      ...
      },
      {
        title: "Smart Alerts",
        description:
          "Set up intelligent alerts for key metrics and unusual patterns.",
        icon: Bell,
      },
      {
        title: "Predictive Insights",
        description:
          "Forecast trends and identify opportunities with AI-powered analytics.",
        icon: Zap,
      },
      {
        title: "Data Integration",
        description:
          "Connect and analyze data from multiple sources in one platform.",
        icon: Share2,
      },
    ],
    ...
    methodology: {
      ...
      description:
        "A structured approach to implementing analytics that deliver real value.",
      steps: [
