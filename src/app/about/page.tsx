...
import { ChevronRight, Globe2, Users, Target, Lightbulb, Network, Building2 } from 'lucide-react';
  ...
  const timeline: Timeline[] = [
    {
      ...
      description: "Established to provide innovative technology solutions for enterprise digital transformation."
    },
    {
      year: "2018",
      title: "Global Expansion",
      description: "Expanded operations to key markets in Europe and Asia, establishing our global presence."
    },
    {
      year: "2020",
      title: "Cloud Practice Launch",
      description: "Launched comprehensive cloud services and solutions for enterprise modernization."
    },
    {
      year: "2023",
      title: "AI & Data Practice",
      description: "Established dedicated AI and Data Analytics practice to drive intelligent transformation."
    }
  ];
          ...
          <div className="container mx-auto px-6 h-full flex items-center">
            <div className="max-w-3xl">
              ...
              <p className="hero-description text-xl text-gray-200">
                For over a decade, Debite has helped enterprises navigate their digital journeys. 
                We combine deep industry expertise with applied innovation to create lasting value through 
            ...
            {timeline.map((item, index) => (
              ...
              >
                <div className="md:w-1/4">
                  <span className="text-3xl font-bold text-gold-300">{item.year}</span>
                </div>
